...
public class CustomerUI {
    ...
    public CustomerUI(Scanner scanner, String loggedInUser, String userRole) {
    ...
    public void start() {
        while (true) {
            CustomerUtils.printHeader("CUSTOMER MANAGEMENT", loggedInUser, userRole);
    ...
    private void handleRegistration() {
        ...
        Customer c = new Customer.Builder()
                .setId(newId).setName(name).setPhone(phone).setEmail(email).build();
