...
public class AircraftService {
    ...
    public static String getValidUniqueName(Scanner scanner, AircraftDAO repo, String prompt) {
        while (true) {
            System.out.print(prompt);
    ...
    public static String getValidUniquePhone(Scanner scanner, AircraftDAO repo, String prompt) {
        while (true) {
            System.out.print(prompt);
            String input = scanner.nextLine().trim();
    ...
    public static String getValidUniqueEmail(Scanner scanner, AircraftDAO repo, String prompt) {
        while (true) {
            System.out.print(prompt);
            String input = scanner.nextLine().trim();
